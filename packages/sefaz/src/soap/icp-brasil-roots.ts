/**
 * Raízes ICP-Brasil confiáveis para o TLS com a SEFAZ.
 *
 * O Node não traz as ACs da ICP-Brasil no repositório de raízes padrão. Em vez
 * de desligar a verificação do servidor — o que várias bibliotecas fazem —, a
 * raiz é fixada aqui, com o fingerprint conferido em teste.
 *
 * AC Raiz Brasileira v10 (SSL), baixada do repositório oficial do ITI
 * (acraiz.icpbrasil.gov.br) em 2026-09-12. Autenticidade conferida por três
 * vias independentes: SHA-256 idêntico ao da raiz instalada no repositório de
 * raízes do Windows; a AC intermediária apresentada pela SEFAZ-SP (AC SOLUTI SSL
 * EV G4) verifica contra esta chave; e o TLS com
 * homologacao.nfe.fazenda.sp.gov.br valida tendo esta raiz como única confiável.
 */

export interface TrustedRoot {
  readonly name: string;
  /** SHA-256 do certificado DER, em hexadecimal separado por dois-pontos. */
  readonly sha256: string;
  readonly source: string;
  readonly pem: string;
}

export const ICP_BRASIL_ROOT_V10: TrustedRoot = Object.freeze({
  name: 'Autoridade Certificadora Raiz Brasileira v10',
  sha256: '6E:0B:FF:06:9A:26:99:4C:15:DE:2C:48:88:CC:54:AF:84:88:2E:54:95:B7:FB:F6:6B:E9:CC:FF:EC:74:89:F6',
...
/** Raízes usadas por padrão no transporte com a SEFAZ-SP. */
export const DEFAULT_SEFAZ_TRUST: readonly TrustedRoot[] = Object.freeze([ICP_BRASIL_ROOT_V10]);
